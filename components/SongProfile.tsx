...
const updateMetaTags = (song: Song) => {
    ...
    const title = `${song.title} by ${song.creator || 'Unknown Artist'} | GetMUSIC`;
    const description = `Listen to "${song.title}" - ${song.style}. ${song.viewCount || 0} plays, ${song.likeCount || 0} likes. Create your own AI music with GetMUSIC.`;
...
const resetMetaTags = () => {
    document.title = 'GetMUSIC - Local AI Music Generator';
    ...
    updateMeta('meta[property="og:title"]', 'GetMUSIC - Local AI Music Generator');
    ...
    updateMeta('meta[name="twitter:title"]', 'GetMUSIC - Local AI Music Generator');
