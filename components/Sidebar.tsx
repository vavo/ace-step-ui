...
import { Library, Disc, Search, LogIn, LogOut, Sun, Moon, GraduationCap, Radio, Trophy, Lightbulb } from 'lucide-react';
...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div className={`
        hidden md:flex flex-col h-full bg-white dark:bg-suno-sidebar border-r border-zinc-200 dark:border-white/5 flex-shrink-0 py-4 overflow-y-auto scrollbar-hide transition-all duration-300
      ...
      <div className="px-3 mb-8 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          {isOpen && (
            <span className="text-lg font-bold text-zinc-900 dark:text-white whitespace-nowrap">getMUSIC</span>
          )}
        </div>
