...
export const translations: Record<string, TranslationBundle> = {
  ...
  sk: {
    ...
    yourName: 'Vaše meno',
    enterYourName: 'Zadajte meno',
    getStarted: 'Začať',
    gettingStarted: 'Spúšťam...',
    yourMusicYourWay: 'Vaša hudba, váš štýl. Vytvárajte neobmedzenú AI hudbu zadarmo.',
    ...
    playlistCreated: 'Playlist bol úspešne vytvorený!',
    failedToCreatePlaylist: 'Nepodarilo sa vytvoriť playlist',
    songAddedToPlaylist: 'Pieseň pridaná do playlistu',
    failedToAddSong: 'Nepodarilo sa pridať pieseň',
    songDeleted: 'Pieseň bola úspešne vymazaná',
    ...
    loraPathPlaceholder: 'Zadajte cestu k modelu LoRA...',
    ...
    loraScaleDescription: 'Upravte vplyv modelu LoRA',
    reference: 'Referencie',
    cover: 'Cover verzia',
    fromLibrary: 'Z knižnice',
    upload: 'Nahrať',
    lyricsPlaceholder: 'Sem zadajte text...',
    leaveLyricsEmpty: 'Nechajte prázdne pre instrumentálnu hudbu',
    vocal: 'Vokál',
    ...
    describeYourSong: 'OPÍSITE SVOJU PIESŇ',
    songDescriptionPlaceholder: 'Veselá pop skladba o letných dobrodružstvách s kamarátmi...',
    quickSettings: 'RÝCHLE NASTAVENIA',
    key: 'Kľúč',
    time: 'Rytmus',
    loginToGenerate: 'Na generovanie sa prihláste',
    uploadFailed: 'Nahrávanie zlyhalo',
    formatFailed: 'Formátovanie zlyhalo',
    formatFailedDetail: 'Formátovanie zlyhalo. Uistite sa, že je LLM pripravené.',
    formatFailedLlmUnavailable: 'Formátovanie zlyhalo. LLM môže byť nedostupné.',
    deleteSongConfirm: 'Naozaj chcete vymazať "{title}"? Túto akciu nemožno vrátiť.',
    profileUpdateFailed: 'Nepodarilo sa aktualizovať profil',
    searchYourSongs: 'Hľadať vaše piesne...',
    filters: 'Filtre',
    refineBy: 'FILTRUJTE PODĽA',
    liked: 'Páči sa',
    private: 'Súkromné',
    generatingStatus: 'Generovanie',
    selectSongToView: 'Vyberte skladbu na zobrazenie',
    noSongsMatchFilters: 'Žiadne skladby nevyhovujú filtrom.',
    ...
    clickToUploadBanner: 'Kliknite pre nahratie bannera',
    bannerFormats: 'Odporúčané: 1500x500px • JPG, PNG, WebP, GIF • Max 5 MB',
    bio: 'O mne',
    bioPlaceholder: 'Napíšte niečo o sebe...',
    ...
    signInToReport: 'Prihláste sa pre nahlásenie alebo blokovanie',
    ...
    emailSubject: 'Vyskúšajte si túto AI pieseň',
    ...
    referenceModalDescription: 'Vytvorte skladbu inšpirovanú referenčnou stopou',
    ...
    trainingDescription: 'Vytvorte datasety z vašich zvukových súborov a trénujte LoRA adaptéry',
    ...
    autoLabelDescription: 'Vygenerujte metadáta pre súbory: caption, BPM, kľúč a takt',
    ...
    chooseOneOption: 'Zvoľte jednu možnosť: Načítať existujúci dataset alebo prehľadať nový priečinok',
    ...
    deletePlaylistConfirm: 'Naozaj chcete zmazať tento playlist?',
    addSong: 'Pridať pieseň',
    addSongToPlaylist: 'Pridať pieseň do playlistu',
    searchYourSongs: 'Hľadať v mojich piesňach...',
    ...
    deleteSongsConfirm: 'Vymazať {count} piesní? Túto akciu nie je možné vrátiť späť.',
    deleteUploadConfirm: 'Vymazať toto nahratie? Túto akciu nie je možné vrátiť späť.',
    dropToUpload: 'Pretiahnite sem pre nahratie',
    dropToUseAudio: 'Pretiahnite sem na použitie zvuku',
    downloadAudio: 'Stiahnuť audio',
    editAudio: 'Upraviť audio',
    enhance: 'AI vylepšenie',
    enhanceHint: 'presnejší žáner, o niečo pomalšie',
    enhanceTooltip: 'Používa jazykový model AI na obohatenie štítkov žánrov o detailný hudobný popis a určenie BPM, tóniny a rytmiky. Zlepšuje presnosť žánru, ale pridáva 10–20 s k času generovania. Nepotrebujete extra VRAM.',
    ffmpegLoadFailed: 'Nepodarilo sa nahrať video enkodér. Obnovte stránku a skúste znova.',
    ...
    noCreatorsYet: 'Zatiaľ žiadni tvorcovia. Buďte prvým, kto zdieľa hudbu.',
    noPlaylistsFound: 'Nenašli sa žiadne playlisty',
    noPlaylistsYet: 'Zatiaľ žiadne verejné playlisty. Vytvorte si ich a zdieľajte obľúbené skladby.',
    ...
    lmModelHint: 'Nastavuje LLM použitú na vylepšenie textu a štýlu. Ak nie je prítomná, automaticky sa stiahne.',
    lmModelLabel: 'LM model',
    ...
    enterFixedSeed: 'Zadajte pevný seed',
    songs: 'skladby',
    ...
    videoRenderFailed: 'Renderovanie videa zlyhalo. Skúste znova.',
    variations: 'Variácie',
    ...
    selectSongToPlay: 'Vyberte pieseň na prehratie',
