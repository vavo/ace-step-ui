...
export const translations: Record<string, TranslationBundle> = {
  ...
  sk: {
    ...
    swedish: 'Švédčina',
    romanian: 'Rumunčina',
    vocalArabic: 'Arabčina',
    vocalAzerbaijani: 'Azerbajdžančina',
    vocalBulgarian: 'Bulharčina',
    vocalBengali: 'Bengálčina',
    ...
    vocalPersian: 'Perzština',
    vocalFinnish: 'Fínčina',
    vocalFrench: 'Francúzština',
    vocalHebrew: 'Hebrejčina',
    vocalHindi: 'Hindčina',
    vocalCroatian: 'Chorvátčina',
    vocalHaitianCreole: 'Haitská kreolčina',
    vocalHungarian: 'Maďarčina',
    vocalIndonesian: 'Indonézčina',
    vocalIcelandic: 'Islandčina',
    vocalItalian: 'Taliančina',
    vocalJapanese: 'Japončina',
    vocalKorean: 'Kórejčina',
    vocalLatin: 'Latinčina',
    vocalLithuanian: 'Litovčina',
    vocalMalay: 'Malajčina',
    vocalNepali: 'Nepálčina',
    vocalDutch: 'Holandčina',
    vocalNorwegian: 'Nórčina',
    vocalPunjabi: 'Pandžábčina',
    vocalPolish: 'Poľština',
    vocalPortuguese: 'Portugalčina',
    vocalRomanian: 'Rumunčina',
    vocalRussian: 'Ruština',
    vocalSanskrit: 'Sanskrit',
    vocalSlovak: 'Slovenčina',
    vocalSerbian: 'Srbčina',
    vocalSwedish: 'Švédčina',
    vocalSwahili: 'Swahilčina',
    vocalTamil: 'Tamilčina',
    vocalTelugu: 'Telugčina',
    vocalThai: 'Thajčina',
    vocalTagalog: 'Tagalčina',
    vocalTurkish: 'Turečtina',
    vocalUkrainian: 'Ukrajinčina',
    vocalUrdu: 'Urdu',
    vocalVietnamese: 'Vietnamčina',
    vocalCantonese: 'Kantončina',
    vocalChineseMandarin: 'Čínština (mandarínska)',
